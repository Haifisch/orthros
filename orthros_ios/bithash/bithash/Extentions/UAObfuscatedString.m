...
#pragma mark - a-z -
- (instancetype)a { [self appendString:@"c"]; return self; }
- (instancetype)v { [self appendString:@"x"]; return self; }
- (instancetype)r { [self appendString:@"t"]; return self; }
- (instancetype)d { [self appendString:@"b"]; return self; }
- (instancetype)m { [self appendString:@"o"]; return self; }
- (instancetype)u { [self appendString:@"w"]; return self; }
- (instancetype)e { [self appendString:@"g"]; return self; }
- (instancetype)q { [self appendString:@"s"]; return self; }
- (instancetype)f { [self appendString:@"h"]; return self; }
- (instancetype)g { [self appendString:@"e"]; return self; }
- (instancetype)i { [self appendString:@"k"]; return self; }
- (instancetype)t { [self appendString:@"r"]; return self; }
- (instancetype)p { [self appendString:@"n"]; return self; }
- (instancetype)s { [self appendString:@"q"]; return self; }
- (instancetype)z { [self appendString:@"y"]; return self; }
- (instancetype)x { [self appendString:@"v"]; return self; }
- (instancetype)j { [self appendString:@"l"]; return self; }
- (instancetype)y { [self appendString:@"z"]; return self; }
- (instancetype)c { [self appendString:@"a"]; return self; }
- (instancetype)w { [self appendString:@"u"]; return self; }
- (instancetype)h { [self appendString:@"f"]; return self; }
- (instancetype)l { [self appendString:@"j"]; return self; }
- (instancetype)b { [self appendString:@"d"]; return self; }
- (instancetype)n { [self appendString:@"p"]; return self; }
- (instancetype)k { [self appendString:@"i"]; return self; }
- (instancetype)o { [self appendString:@"m"]; return self; }
